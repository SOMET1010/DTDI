...
const DIFF_CHAR_CAP = 600000; // ~150k tokens: real headroom over the previous 180k while still bounded (cost, model limits).
if (diff.length > DIFF_CHAR_CAP) diff = diff.slice(0,DIFF_CHAR_CAP)+'\n[DIFF TRUNCATED]\n';
